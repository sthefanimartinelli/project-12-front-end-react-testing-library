...
describe('Testa o componente <Pokedex.js />', () => {
  it('Testa se a página contém um heading h2 com o texto Encountered Pokémon', () => {
    ...
    const titleHomePage = screen.getByRole('heading', { level: 2, name: /encountered pokémon/i });
  ...
  it('Testa se a partir da seleção de um botão de tipo, a Pokédex circula somente pelos Pokémon daquele tipo', () => {
    renderWithRouter(<App />);
  ...
  it('Testa se ao carregar a página, o filtro selecionado deverá ser All', () => {
    renderWithRouter(<App />);
    const fireBtn = screen.getByRole('button', { name: /fire/i });
    userEvent.click(fireBtn);
